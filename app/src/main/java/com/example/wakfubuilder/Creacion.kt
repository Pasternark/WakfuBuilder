...
class Creacion : ComponentActivity() {
...
@Composable
fun WakfuCreateTopBar(modifier: Modifier = Modifier) {
    CenterAlignedTopAppBar(
        ...
        title = {
            Row(
                ...
                Text(
                    text = stringResource(R.string.nuevaBuild),
                )
            }
        }
    )
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun WakfuCreateBottomBar(modifier: Modifier = Modifier) {
    CenterAlignedTopAppBar(
        title = {
